...
def load_config(path: Path | None = None) -> AppConfig:
    ...
    return AppConfig(
        ...
        notification_cert_path=raw.get("notification_cert_path", "/data/notification_cert.pem"),
        notification_key_path=raw.get("notification_key_path", "/data/notification_key.pem"),
